...
import { Brain, Loader2, TrendingUp, TrendingDown, Minus, RefreshCw, Lightbulb } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Análise preditiva de resultados eleitorais utilizando inteligência artificial"
        breadcrumbs={[
